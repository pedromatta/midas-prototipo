...
const Sidebar = ({ t, activeTab, navigateToTab, setIsDark }) => (
  <aside className={`hidden md:flex flex-col w-64 ${t.sidebar} text-[#FDFDFA] min-h-screen fixed left-0 top-0 transition-colors border-r ${t.border} z-10`}>
    <div
      className="px-8 pt-8 pb-6 cursor-pointer"
      onClick={() => navigateToTab('dashboard')}
      role="button"
      tabIndex={0}
    >
      {/* <h1 className="text-2xl font-black tracking-wider text-[#D4AF37]">MIDAS</h1> */}
      <img className="image-2xl tracking-wider" src="/images/logo-horizontal.svg" />
    </div>
