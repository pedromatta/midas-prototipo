  ...
  <div className="p-6 max-w-4xl mx-auto space-y-8 pb-24">
    ...
    <section className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <input type="text" readOnly value="C:\Users\User\Documents\Midas\" className={`w-full p-3 ${t.bgInput} border ${t.border} rounded-lg ${t.textMain} font-mono text-sm`} />
    ...
    <section className="space-y-4">
      <h2 className={`text-xl font-bold ${t.textMain} flex items-center border-b ${t.border} pb-2`}><Building className="mr-2" /> API de Cotações</h2>
      <div className={`flex items-center justify-between ${t.bgCard} p-4 rounded-xl border ${t.border} shadow-sm transition-colors`}>
        <div className="flex items-center space-x-3">
          <div className={`p-2 bg-[#1A3E4E] text-[#FDFDFA] ${t.textMain} rounded-full`}><RefreshCw size={24} /></div>
